 ...
 <?php if($Action  == "Create"){ ?>
    <div class="right_col" role="main">
        <div class="">
            ...
            <!--        <h3><small>Create Payment</small></h3>-->
            <!--    </div>-->
                        ...
                        <div class="x_content">
                            <form name="CreateContactForm" autocomplete="off" id="CreateContactForm" action="action/CreateContact.php" method="post" novalidate>                        
                               <input type="hidden" value="View" id="IDView" name="View">
                                <span class="section">Create - Payment Voucher</span>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        <input class="form-control" type="number" name="Amount" id="Amount" required='required' maxlength="10" placeholder="Enter Amount" /><span id="MSG_MobileNumber"></span></div>
                                    </div>
...
<script type="text/javascript">
   ...
   $("#ContactName").focus();
    ...
    $(document).on('keyup','#ContactName,#Designation',function(){
