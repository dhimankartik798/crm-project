...
<div class="right_col" role="main">
  ...
  <div class="tile_count">
    <div class="col-md-2 col-sm-4  tile_stats_count">
      <span class="count_top"><i class="fa fa-home"></i> Total Companies</span>
      <div class="count" id="TotalCompanies"></div>
      <!-- <span class="count_bottom"><i class="green">4% </i> From last Week</span> -->
    </div>
    <div class="col-md-2 col-sm-4  tile_stats_count">
      <span class="count_top"><i class="fa fa-clock-o"></i> Total Contacts</span>
      <div class="count"  id="TotalContacts"></div>
...
$.ajax({
    ...
    data: {action:'Display_Total_No_Company_Data'},
    ...
    // $.get("action/CreateCompany.php",{action:'Display_Company_Data'},function(data, status){
      ...
      $.each(ActualData, function(i,val) {
           $('#TotalCompanies').text(val.TotalCompanies);
      });
    }
});
TotalContacts
...
$.ajax({
    ...
    data: {action:'Display_Total_No_Contact_Data'},
    success: function (data) {
    // $.get("action/CreateCompany.php",{action:'Display_Company_Data'},function(data, status){
      let ContactData = JSON.parse(data);
      $.each(ContactData, function(i,val) {
           $('#TotalContacts').text(val.TotalContact);
      });
    }
});
</script>